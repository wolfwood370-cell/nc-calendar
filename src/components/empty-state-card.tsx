...
export function EmptyStateCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-[32px] border border-outline-variant/30 bg-surface-container-lowest p-8 text-center shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
      ...
      <div className="pointer-events-none absolute -bottom-20 -left-12 h-40 w-40 rounded-full bg-secondary/10 blur-3xl" />
      <div className="relative flex flex-col items-center gap-4">
        ...
        <Link
          to={ctaTo}
          className="mt-2 inline-flex items-center justify-center rounded-full bg-[#005685] px-7 py-3 text-sm font-semibold text-white shadow-md transition-transform active:scale-95 hover:opacity-95"
        >
          {ctaLabel}
        </Link>
      </div>
