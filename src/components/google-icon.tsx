export interface GoogleIconProps {
  /** Classi Tailwind/CSS aggiuntive (es. `size-5`). */
  className?: string;
}

/**
 * Logo Google ufficiale (4-path SVG) — usato dal bottone "Continua con
 * Google" nella pagina /auth. Estratto da auth.tsx come standalone così
 * altri eventuali touch-point Google (es. setting collegamento account
 * coach) possono riusarlo senza duplicare il path data.
 */
