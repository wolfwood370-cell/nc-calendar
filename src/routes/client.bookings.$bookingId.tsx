...
// Auto-merge resolution: origin/main also moved away from <Skeleton>
// and added AuraLineSkeleton. Union of both imports — drop the legacy
// Skeleton (no remaining callers in this file).
      ...
      <div className="max-w-md mx-auto relative pb-24">
        ...
        <main className="px-margin-mobile space-y-gutter">
          {q.isLoading ? (
            ...
            <>
              {/* Auto-merge resolution: origin/main composed richer
                  placeholders with inner lines; kept that version since
                  it matches the resolved layout more precisely. */}
